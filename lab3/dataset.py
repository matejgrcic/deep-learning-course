...
class Data:
    ...
    def create_minibatches(self):
        self.num_batches = len(self.x) // (self.batch_size * (self.sequence_length + 1))
        # TODO
        ...
        for i in range(self.num_batches):
            ...
            for j in range(self.batch_size):
                start = i * (self.batch_size * (self.sequence_length)) + j * self.sequence_length
...
if __name__ == "__main__":
    ...
    for i in range(d.num_batches):
        a, _, _ = d.next_minibatch()
        print(i, a)