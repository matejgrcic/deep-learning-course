...
class FC(Layer):
    ...
    def backward_inputs(self, grads):
        ...
        """
        # TODO
        return np.matmul(grads, self.weights)
    ...
    def backward_params(self, grads):
        ...
        """
        # TODO
        grad_weights = np.matmul(grads.T, self.inputs)
...
class SoftmaxCrossEntropyWithLogits():
    ...
    def forward(self, x, y):
        ...
        """
        return np.average(np.log((np.sum(np.exp(x), axis=1))) - np.sum(x * y, axis=1))
    ...
    def backward_inputs(self, x, y):
        ...
        return (((np.exp(x)).T/np.sum(np.exp(x), axis=1)).T - y)/x.shape[0]
...
class L2Regularizer():
    ...
    def forward(self):
        ...
        """
        return 0.5 * self.weight_decay * np.linalg.norm(self.weights)
    ...
    def backward_params(self):
        ...
        """
        # TODO
        grad_weights = 0.5 * self.weight_decay * self.weights
